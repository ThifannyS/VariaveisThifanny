...
let anoAtual = 2024; 
const nomeCompleto = "Thifanny";
let idade = 17;
const cursoFaculdade = "Psicologia";
let cidadeAtual = "São José dos Pinhais";

console.log(`olá eu sou a ${nomeCompleto} eu tenho ${idade} anos, moro em ${cidadeAtual} ano que vem quero estar cursando ${cursoFaculdade}`);
